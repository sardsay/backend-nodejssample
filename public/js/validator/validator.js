...
var validator = (function($){
    ...
    */
    message = {
        ...
        email_duplicated: 'email invalid',
    ...
    var emailList = [];
    $.get( "/users/emails", function( result ) {
            $.each(result,function(index,value){
                emailList[value.email] = value.email;
            })
    ...
    */
    tests = {
        ...
        email : function(a){
            ...
            if (emailList[a]) {
                alertTxt = message.email_duplicated;
                return false;
            }
    ...
    */
    function checkField(){
        ...
        */
        ...
        data.valid = tests.hasValue(data.val,data.type);
